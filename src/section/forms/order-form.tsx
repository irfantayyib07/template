  ...
  <>
   <Grid container spacing={2}>
    ...
    <Grid item xs={12} sm={9}>
     <BasicTextFields size="small" defaultValue={mode === "edit" ? orderTitle : null} fullWidth />
    </Grid>
    ...
    <Grid item xs={12} container alignItems="center">
     ...
     <Grid item xs={12} sm={9}>
      <BasicTextFields size="small" defaultValue={mode === "edit" ? customerPrice : null} fullWidth />
     </Grid>
    </Grid>
    <Grid item xs={12} container alignItems="center">
     <Grid item xs={12} sm={3}>
     ...
     <Grid item xs={12} sm={9}>
      <BasicTextFields size="small" defaultValue={mode === "edit" ? remainingAmount : null} fullWidth />
     </Grid>
    </Grid>
